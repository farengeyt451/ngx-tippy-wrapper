...
import { NgxTippyGroupComponent } from '../../projects/ngx-tippy-wrapper/src/lib/ngx-tippy-group.component';

@NgModule({
  declarations: [AppComponent, NgxTippyDirective, NgxTippySingletonComponent, NgxTippyGroupComponent],
